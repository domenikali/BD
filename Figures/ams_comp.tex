...
\caption{Comparison between optimised and un-optimised function setup and variable access. Generated using Compiler Explorer \cite{godbolt_compiler_nodate}.}

...
\begin{figure}[!htb]
\begin{adjustwidth}{-1.75cm}{-1.75cm} % expands margins: left, right

\begin{minipage}{1.25\textwidth}
    {\includegraphics[width=\textwidth]{Figures/mvm_benchmark_dispersion_plot (1).png}
    \label{fig:no_opt_plot}}
\end{minipage}
\hfill
\begin{minipage}{1.25\textwidth}
    {\includegraphics[width=\textwidth]{Figures/mvm_benchmark_dispersion_plot.png}
    \label{fig:opt_plot}}
\end{minipage}

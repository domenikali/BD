...
PCM is particularly suitable for this type of application because its analog resistance states can naturally represent neural network weights, and its crossbar architecture allows for parallel computation of matrix-vector multiplications in a single analog operation.
...
The flat buffer data structure reduces data reads by up to $5\times$ compared to a standard multidimensional array approach, 
